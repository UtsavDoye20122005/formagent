...
- Use "email" for email, "tel" for phone, "date" for dates, "textarea" for anything long, "rating" for a 1-5 score, "boolean" for a single yes/no, and "file" when they ask people to attach or upload something (a resume, a photo, an ID, a certificate).
